...
error_msg = "\nError \n"
i2c_err_str = "Pico could not communicate with module at address 0x{:02X}, check wiring"
...
class MPU6050(object):     
    def __init__(self, bus=None, freq=None, sda=None, scl=None, addr=_MPU6050_ADDRESS,i2c_instance=None):
        ...
        if i2c_instance:
            ...
            self.i2c = I2C(0, scl=Pin(scl or 21), sda=Pin(sda or 20), freq=freq or 100000)
